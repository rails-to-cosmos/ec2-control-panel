...
// Stop terminates the running instance for sessionID. When force is true and
...
func Stop(ctx context.Context, env *config.EnvConfig, sessionID, az string, force, yes bool, confirmer func(prompt, sessionID string, yes bool) error) error {
